...
class nuSQUIDSAtm {
  ...
  public:
    ...
    *************************************************************************************/
    ...
    double EvalFlavor(unsigned int flv,double costh,double enu,unsigned int rho = 0,double production_height = 0) const {
      ...
      double delta_t_final = track.GetFinalX()-track.GetInitialX() + production_height*units.km;
